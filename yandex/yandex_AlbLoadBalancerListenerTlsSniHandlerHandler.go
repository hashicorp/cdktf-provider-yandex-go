...
type AlbLoadBalancerListenerTlsSniHandlerHandler struct {
	...
	HttpHandler *AlbLoadBalancerListenerTlsSniHandlerHandlerHttpHandler `field:"optional" json:"httpHandler" yaml:"httpHandler"`
	...
	StreamHandler *AlbLoadBalancerListenerTlsSniHandlerHandlerStreamHandler `field:"optional" json:"streamHandler" yaml:"streamHandler"`
}
