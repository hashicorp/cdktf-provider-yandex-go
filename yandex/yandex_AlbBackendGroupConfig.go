...
type AlbBackendGroupConfig struct {
	// Experimental.
	...
	SessionAffinity *AlbBackendGroupSessionAffinity `field:"optional" json:"sessionAffinity" yaml:"sessionAffinity"`
	...
	Timeouts *AlbBackendGroupTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
