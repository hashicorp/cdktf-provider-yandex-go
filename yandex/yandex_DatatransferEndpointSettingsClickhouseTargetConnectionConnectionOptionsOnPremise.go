...
type DatatransferEndpointSettingsClickhouseTargetConnectionConnectionOptionsOnPremise struct {
	...
	TlsMode *DatatransferEndpointSettingsClickhouseTargetConnectionConnectionOptionsOnPremiseTlsMode `field:"optional" json:"tlsMode" yaml:"tlsMode"`
}
