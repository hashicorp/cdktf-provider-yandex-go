...
type DatatransferEndpointSettingsPostgresTargetConnection struct {
	...
	OnPremise *DatatransferEndpointSettingsPostgresTargetConnectionOnPremise `field:"optional" json:"onPremise" yaml:"onPremise"`
}
