...
type AlbBackendGroupStreamBackend struct {
	...
	Healthcheck *AlbBackendGroupStreamBackendHealthcheck `field:"optional" json:"healthcheck" yaml:"healthcheck"`
	...
	LoadBalancingConfig *AlbBackendGroupStreamBackendLoadBalancingConfig `field:"optional" json:"loadBalancingConfig" yaml:"loadBalancingConfig"`
	...
	Tls *AlbBackendGroupStreamBackendTls `field:"optional" json:"tls" yaml:"tls"`
