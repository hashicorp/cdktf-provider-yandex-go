...
type DatatransferEndpointSettingsMysqlSourceConnection struct {
	...
	OnPremise *DatatransferEndpointSettingsMysqlSourceConnectionOnPremise `field:"optional" json:"onPremise" yaml:"onPremise"`
}
