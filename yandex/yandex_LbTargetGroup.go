...
type LbTargetGroup interface {
	...
	Target() LbTargetGroupTargetList
	...
	Timeouts() LbTargetGroupTimeoutsOutputReference
	...
	PutTimeouts(value *LbTargetGroupTimeouts)
	ResetDescription()
	ResetFolderId()
	ResetId()
	ResetLabels()
...
func (j *jsiiProxy_LbTargetGroup) CreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdAt",
...
func (j *jsiiProxy_LbTargetGroup) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_LbTargetGroup) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_LbTargetGroup) FolderId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"folderId",
...
func (j *jsiiProxy_LbTargetGroup) FolderIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"folderIdInput",
...
func (j *jsiiProxy_LbTargetGroup) Labels() *map[string]*string {
...
func (j *jsiiProxy_LbTargetGroup) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_LbTargetGroup) RegionId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionId",
...
func (j *jsiiProxy_LbTargetGroup) RegionIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionIdInput",
...
func (j *jsiiProxy_LbTargetGroup) Target() LbTargetGroupTargetList {
	var returns LbTargetGroupTargetList
	_jsii_.Get(
		j,
		"target",
		&returns,
...
func (j *jsiiProxy_LbTargetGroup) TargetInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"targetInput",
...
func (j *jsiiProxy_LbTargetGroup) Timeouts() LbTargetGroupTimeoutsOutputReference {
	var returns LbTargetGroupTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_LbTargetGroup) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
func (j *jsiiProxy_LbTargetGroup) SetDescription(val *string) {
	_jsii_.Set(
		j,
		"description",
		val,
...
func (j *jsiiProxy_LbTargetGroup) SetFolderId(val *string) {
	_jsii_.Set(
		j,
		"folderId",
		val,
...
func (j *jsiiProxy_LbTargetGroup) SetLabels(val *map[string]*string) {
	_jsii_.Set(
		j,
		"labels",
		val,
...
func (j *jsiiProxy_LbTargetGroup) SetRegionId(val *string) {
	_jsii_.Set(
		j,
		"regionId",
		val,
...
func (l *jsiiProxy_LbTargetGroup) PutTarget(value interface{}) {
	_jsii_.InvokeVoid(
		l,
		"putTarget",
		[]interface{}{value},
...
func (l *jsiiProxy_LbTargetGroup) PutTimeouts(value *LbTargetGroupTimeouts) {
	_jsii_.InvokeVoid(
		l,
		"putTimeouts",
		[]interface{}{value},
...
func (l *jsiiProxy_LbTargetGroup) ResetDescription() {
	_jsii_.InvokeVoid(
		l,
		"resetDescription",
		nil, // no parameters
...
func (l *jsiiProxy_LbTargetGroup) ResetFolderId() {
	_jsii_.InvokeVoid(
		l,
		"resetFolderId",
		nil, // no parameters
...
func (l *jsiiProxy_LbTargetGroup) ResetLabels() {
	_jsii_.InvokeVoid(
		l,
		"resetLabels",
		nil, // no parameters
...
func (l *jsiiProxy_LbTargetGroup) ResetRegionId() {
	_jsii_.InvokeVoid(
		l,
		"resetRegionId",
		nil, // no parameters
...
func (l *jsiiProxy_LbTargetGroup) ResetTarget() {
	_jsii_.InvokeVoid(
		l,
		"resetTarget",
		nil, // no parameters
...
func (l *jsiiProxy_LbTargetGroup) ResetTimeouts() {
	_jsii_.InvokeVoid(
		l,
		"resetTimeouts",
		nil, // no parameters
