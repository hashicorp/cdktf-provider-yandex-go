...
// Represents a {@link https://www.terraform.io/docs/providers/yandex/r/container_registry yandex_container_registry}.
...
func (j *jsiiProxy_ContainerRegistry) FolderId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"folderId",
...
func (j *jsiiProxy_ContainerRegistry) FolderIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"folderIdInput",
...
func (j *jsiiProxy_ContainerRegistry) Labels() *map[string]*string {
...
func (j *jsiiProxy_ContainerRegistry) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_ContainerRegistry) Status() *string {
	var returns *string
	_jsii_.Get(
		j,
		"status",
...
// Create a new {@link https://www.terraform.io/docs/providers/yandex/r/container_registry yandex_container_registry} Resource.
...
func (j *jsiiProxy_ContainerRegistry) SetFolderId(val *string) {
	_jsii_.Set(
		j,
		"folderId",
		val,
...
func (j *jsiiProxy_ContainerRegistry) SetLabels(val *map[string]*string) {
	_jsii_.Set(
		j,
		"labels",
		val,
...
func (c *jsiiProxy_ContainerRegistry) ResetFolderId() {
	_jsii_.InvokeVoid(
		c,
		"resetFolderId",
		nil, // no parameters
...
func (c *jsiiProxy_ContainerRegistry) ResetLabels() {
	_jsii_.InvokeVoid(
		c,
		"resetLabels",
		nil, // no parameters
...
func (c *jsiiProxy_ContainerRegistry) ResetName() {
	_jsii_.InvokeVoid(
		c,
		"resetName",
		nil, // no parameters
