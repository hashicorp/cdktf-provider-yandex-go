...
type DatatransferEndpointSettingsMysqlSourceConnectionOnPremise struct {
	...
	TlsMode *DatatransferEndpointSettingsMysqlSourceConnectionOnPremiseTlsMode `field:"optional" json:"tlsMode" yaml:"tlsMode"`
}
