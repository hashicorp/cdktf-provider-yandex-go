...
type DataYandexAlbBackendGroupHttpBackendHealthcheck struct {
	...
	GrpcHealthcheck *DataYandexAlbBackendGroupHttpBackendHealthcheckGrpcHealthcheck `field:"optional" json:"grpcHealthcheck" yaml:"grpcHealthcheck"`
	...
	HttpHealthcheck *DataYandexAlbBackendGroupHttpBackendHealthcheckHttpHealthcheck `field:"optional" json:"httpHealthcheck" yaml:"httpHealthcheck"`
	...
	StreamHealthcheck *DataYandexAlbBackendGroupHttpBackendHealthcheckStreamHealthcheck `field:"optional" json:"streamHealthcheck" yaml:"streamHealthcheck"`
