...
type DatatransferEndpointSettingsMysqlTargetConnectionOnPremise struct {
	...
	TlsMode *DatatransferEndpointSettingsMysqlTargetConnectionOnPremiseTlsMode `field:"optional" json:"tlsMode" yaml:"tlsMode"`
}
