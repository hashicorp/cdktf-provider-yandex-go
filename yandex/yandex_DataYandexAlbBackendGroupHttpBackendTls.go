...
type DataYandexAlbBackendGroupHttpBackendTls struct {
	...
	ValidationContext *DataYandexAlbBackendGroupHttpBackendTlsValidationContext `field:"optional" json:"validationContext" yaml:"validationContext"`
}
