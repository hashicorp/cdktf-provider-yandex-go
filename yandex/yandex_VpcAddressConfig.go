...
type VpcAddressConfig struct {
	...
	ExternalIpv4Address *VpcAddressExternalIpv4Address `field:"optional" json:"externalIpv4Address" yaml:"externalIpv4Address"`
	...
	Timeouts *VpcAddressTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
