...
type DatatransferEndpointSettingsPostgresTargetConnectionOnPremise struct {
	...
	TlsMode *DatatransferEndpointSettingsPostgresTargetConnectionOnPremiseTlsMode `field:"optional" json:"tlsMode" yaml:"tlsMode"`
}
