...
type DataYandexMdbSqlserverClusterConfig struct {
	// Experimental.
	...
	// Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/yandex/d/mdb_sqlserver_cluster#id DataYandexMdbSqlserverCluster#id}.
	//
