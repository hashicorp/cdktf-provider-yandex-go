...
type DataYandexComputeInstanceConfig struct {
	// Experimental.
	...
	PlacementPolicy *DataYandexComputeInstancePlacementPolicy `field:"optional" json:"placementPolicy" yaml:"placementPolicy"`
}
