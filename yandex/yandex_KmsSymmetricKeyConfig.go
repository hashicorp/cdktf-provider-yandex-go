...
type KmsSymmetricKeyConfig struct {
	// Experimental.
	...
	DefaultAlgorithm *string `field:"optional" json:"defaultAlgorithm" yaml:"defaultAlgorithm"`
	...
	// Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/yandex/r/kms_symmetric_key#id KmsSymmetricKey#id}.
	//
	...
	Timeouts *KmsSymmetricKeyTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
