...
type DataYandexVpcNetworkConfig struct {
	// Experimental.
	...
	// Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/yandex/d/vpc_network#id DataYandexVpcNetwork#id}.
	//
