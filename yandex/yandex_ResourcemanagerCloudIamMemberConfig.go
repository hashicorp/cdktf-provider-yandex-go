...
type ResourcemanagerCloudIamMemberConfig struct {
	// Experimental.
	...
	// Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/yandex/r/resourcemanager_cloud_iam_member#id ResourcemanagerCloudIamMember#id}.
	//
