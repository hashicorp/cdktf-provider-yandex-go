...
type DatatransferEndpointSettingsMongoSourceConnectionConnectionOptions struct {
	...
	OnPremise *DatatransferEndpointSettingsMongoSourceConnectionConnectionOptionsOnPremise `field:"optional" json:"onPremise" yaml:"onPremise"`
	// password block.
	//
	...
	Password *DatatransferEndpointSettingsMongoSourceConnectionConnectionOptionsPassword `field:"optional" json:"password" yaml:"password"`
