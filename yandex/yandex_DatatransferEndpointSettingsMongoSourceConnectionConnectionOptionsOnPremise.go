...
type DatatransferEndpointSettingsMongoSourceConnectionConnectionOptionsOnPremise struct {
	...
	TlsMode *DatatransferEndpointSettingsMongoSourceConnectionConnectionOptionsOnPremiseTlsMode `field:"optional" json:"tlsMode" yaml:"tlsMode"`
}
