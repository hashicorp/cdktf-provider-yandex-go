...
type DataYandexAlbBackendGroupGrpcBackendHealthcheck struct {
	...
	GrpcHealthcheck *DataYandexAlbBackendGroupGrpcBackendHealthcheckGrpcHealthcheck `field:"optional" json:"grpcHealthcheck" yaml:"grpcHealthcheck"`
	...
	HttpHealthcheck *DataYandexAlbBackendGroupGrpcBackendHealthcheckHttpHealthcheck `field:"optional" json:"httpHealthcheck" yaml:"httpHealthcheck"`
	...
	StreamHealthcheck *DataYandexAlbBackendGroupGrpcBackendHealthcheckStreamHealthcheck `field:"optional" json:"streamHealthcheck" yaml:"streamHealthcheck"`
