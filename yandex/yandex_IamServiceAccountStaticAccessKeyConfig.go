...
type IamServiceAccountStaticAccessKeyConfig struct {
	// Experimental.
	...
	// Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/yandex/r/iam_service_account_static_access_key#id IamServiceAccountStaticAccessKey#id}.
	//
