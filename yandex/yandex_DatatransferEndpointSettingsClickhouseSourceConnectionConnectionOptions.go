...
type DatatransferEndpointSettingsClickhouseSourceConnectionConnectionOptions struct {
	...
	OnPremise *DatatransferEndpointSettingsClickhouseSourceConnectionConnectionOptionsOnPremise `field:"optional" json:"onPremise" yaml:"onPremise"`
	// password block.
	//
	...
	Password *DatatransferEndpointSettingsClickhouseSourceConnectionConnectionOptionsPassword `field:"optional" json:"password" yaml:"password"`
