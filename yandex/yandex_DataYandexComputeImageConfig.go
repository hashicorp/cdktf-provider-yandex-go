...
type DataYandexComputeImageConfig struct {
	// Experimental.
	...
	// Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/yandex/d/compute_image#id DataYandexComputeImage#id}.
	//
