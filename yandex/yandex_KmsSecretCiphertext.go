...
type KmsSecretCiphertext interface {
	...
	AadContext() *string
	SetAadContext(val *string)
	AadContextInput() *string
	// Experimental.
...
func (j *jsiiProxy_KmsSecretCiphertext) AadContext() *string {
	var returns *string
	_jsii_.Get(
		j,
		"aadContext",
...
func (j *jsiiProxy_KmsSecretCiphertext) AadContextInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"aadContextInput",
...
func (j *jsiiProxy_KmsSecretCiphertext) KeyId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"keyId",
...
func (j *jsiiProxy_KmsSecretCiphertext) KeyIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"keyIdInput",
...
func (j *jsiiProxy_KmsSecretCiphertext) SetAadContext(val *string) {
	_jsii_.Set(
		j,
		"aadContext",
		val,
...
func (j *jsiiProxy_KmsSecretCiphertext) SetKeyId(val *string) {
	_jsii_.Set(
		j,
		"keyId",
		val,
...
func (k *jsiiProxy_KmsSecretCiphertext) ResetAadContext() {
	_jsii_.InvokeVoid(
		k,
		"resetAadContext",
		nil, // no parameters
